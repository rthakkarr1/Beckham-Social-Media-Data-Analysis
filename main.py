...
df = pd.read_csv(r"C:\Users\12019\Desktop\Research Project Files\Beckham.csv")
...
result_df[['Message', 'Categories', 'Topic']].to_csv(r'C:\Users\12019\Desktop\Research Project Files\sentiment_analysis_beckham1.csv', index=False)
